    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRedemptionNonce {
            pub user: Vec<u8>,
        }
        impl GetRedemptionNonce {
            const METHOD_ID: [u8; 4] = [69u8, 139u8, 6u8, 163u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetRedemptionNonce {
            const NAME: &'static str = "getRedemptionNonce";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct GetUsdc {}
        impl GetUsdc {
            const METHOD_ID: [u8; 4] = [18u8, 243u8, 254u8, 118u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetUsdc {
            const NAME: &'static str = "getUsdc";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetUsdc {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        impl PurchaseBundle {
            const METHOD_ID: [u8; 4] = [44u8, 59u8, 51u8, 157u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl PurchaseEdition {
            const METHOD_ID: [u8; 4] = [53u8, 77u8, 27u8, 241u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl PurchaseMysteryBox {
            const METHOD_ID: [u8; 4] = [215u8, 48u8, 172u8, 19u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn decode(
                ...
                Ok(Self {
                    usdc: ethabi::decode(
                        ...
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'usdc' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
