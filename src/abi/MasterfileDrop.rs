    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct FulfillRandomness {
            pub request_id: substreams::scalar::BigInt,
            pub randomness: substreams::scalar::BigInt,
        }
        impl FulfillRandomness {
            const METHOD_ID: [u8; 4] = [6u8, 149u8, 162u8, 82u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.randomness.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for FulfillRandomness {
            const NAME: &'static str = "fulfillRandomness";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetArweaveCid {}
        impl GetArweaveCid {
            const METHOD_ID: [u8; 4] = [32u8, 127u8, 99u8, 105u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetArweaveCid {
            const NAME: &'static str = "getArweaveCID";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<String> for GetArweaveCid {
        ...
        impl GetBundle {
            const METHOD_ID: [u8; 4] = [109u8, 167u8, 136u8, 14u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetBundle {
            const NAME: &'static str = "getBundle";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetConduit {
            const METHOD_ID: [u8; 4] = [132u8, 234u8, 253u8, 160u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetConduit {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetDropWindow {}
        impl GetDropWindow {
            const METHOD_ID: [u8; 4] = [95u8, 47u8, 172u8, 222u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetDropWindow {
            const NAME: &'static str = "getDropWindow";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetEdition {
            const METHOD_ID: [u8; 4] = [166u8, 66u8, 192u8, 50u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetEdition {
            const NAME: &'static str = "getEdition";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetEditions {}
        impl GetEditions {
            const METHOD_ID: [u8; 4] = [223u8, 110u8, 252u8, 108u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetEditions {
            const NAME: &'static str = "getEditions";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetMysteryBox {}
        impl GetMysteryBox {
            const METHOD_ID: [u8; 4] = [124u8, 139u8, 23u8, 232u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetMysteryBox {
            const NAME: &'static str = "getMysteryBox";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRandomnessProvider {}
        impl GetRandomnessProvider {
            const METHOD_ID: [u8; 4] = [97u8, 9u8, 249u8, 182u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetRandomnessProvider {
            const NAME: &'static str = "getRandomnessProvider";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetRandomnessProvider {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRandomnessRequest {
            pub request_id: substreams::scalar::BigInt,
        }
        impl GetRandomnessRequest {
            const METHOD_ID: [u8; 4] = [177u8, 129u8, 238u8, 133u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn output_call(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<(Vec<u8>, [u8; 32usize], substreams::scalar::BigInt), String> {
                Self::output(call.return_data.as_ref())
            }
            pub fn output(
                data: &[u8],
            ...
            pub fn call(
                &self,
                address: Vec<u8>,
            ) -> Option<(Vec<u8>, [u8; 32usize], substreams::scalar::BigInt)> {
                use substreams_ethereum::pb::eth::rpc;
                let rpc_calls = rpc::RpcCalls {
                    calls: vec![
                        rpc::RpcCall { to_addr : address, data : self.encode(), }
        ...
        impl substreams_ethereum::Function for GetRandomnessRequest {
            const NAME: &'static str = "getRandomnessRequest";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<
            (Vec<u8>, [u8; 32usize], substreams::scalar::BigInt),
        > for GetRandomnessRequest {
            fn output(
                data: &[u8],
            ) -> Result<(Vec<u8>, [u8; 32usize], substreams::scalar::BigInt), String> {
                Self::output(data)
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRedemptionNonceStatus {
            pub user: Vec<u8>,
            pub nonce: [u8; 32usize],
        }
        impl GetRedemptionNonceStatus {
            const METHOD_ID: [u8; 4] = [58u8, 234u8, 205u8, 64u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetRedemptionNonceStatus {
            const NAME: &'static str = "getRedemptionNonceStatus";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for GetRedemptionNonceStatus {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetRevenueRecipient {}
        impl GetRevenueRecipient {
            const METHOD_ID: [u8; 4] = [93u8, 89u8, 195u8, 65u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetRevenueRecipient {
            const NAME: &'static str = "getRevenueRecipient";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for GetRevenueRecipient {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetTotalProbability {}
        impl GetTotalProbability {
            const METHOD_ID: [u8; 4] = [83u8, 24u8, 254u8, 21u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetTotalProbability {
            const NAME: &'static str = "getTotalProbability";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Gift {
            const METHOD_ID: [u8; 4] = [89u8, 141u8, 0u8, 169u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for Gift {
        ...
        impl GiftBatch {
            const METHOD_ID: [u8; 4] = [215u8, 65u8, 251u8, 36u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GiftBatch {
            const NAME: &'static str = "giftBatch";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Initialize {
            const METHOD_ID: [u8; 4] = [22u8, 164u8, 81u8, 99u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                    ...
                    &[
                        ethabi::Token::Tuple(
                            vec![
                                ...
                                .details.0.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .details.1.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
        ...
        pub struct PurchaseBundle {
            ...
            pub funder: Vec<u8>,
            pub quantity: substreams::scalar::BigInt,
            pub shipping_cost: substreams::scalar::BigInt,
        }
        impl PurchaseBundle {
            const METHOD_ID: [u8; 4] = [160u8, 14u8, 182u8, 39u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.funder),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.quantity.clone().to_bytes_be() {
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.shipping_cost.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for PurchaseBundle {
            const NAME: &'static str = "purchaseBundle";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl PurchaseEdition {
            const METHOD_ID: [u8; 4] = [175u8, 253u8, 1u8, 119u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for PurchaseEdition {
            const NAME: &'static str = "purchaseEdition";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct PurchaseMysteryBox {
            pub recipient: Vec<u8>,
            pub funder: Vec<u8>,
            pub quantity: substreams::scalar::BigInt,
            pub shipping_cost: substreams::scalar::BigInt,
        }
        impl PurchaseMysteryBox {
            const METHOD_ID: [u8; 4] = [23u8, 123u8, 217u8, 111u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for PurchaseMysteryBox {
            const NAME: &'static str = "purchaseMysteryBox";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl Reveal {
            const METHOD_ID: [u8; 4] = [112u8, 31u8, 208u8, 241u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SetBundle {
            const METHOD_ID: [u8; 4] = [222u8, 110u8, 19u8, 154u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Tuple(
                            vec![
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .bundle.0.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .bundle.1.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),), { let v = self.bundle.2.iter().map(| inner
        ...
        impl substreams_ethereum::Function for SetBundle {
            const NAME: &'static str = "setBundle";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SetDropDetails {
            const METHOD_ID: [u8; 4] = [80u8, 200u8, 34u8, 114u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetDropDetails {
            const NAME: &'static str = "setDropDetails";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
                ...
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Tuple(
                            vec![
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .edition.0.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .edition.1.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .edition.2.clone().to_bytes_be() { (num_bigint::Sign::Plus,
                                bytes) => bytes, (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),)
        ...
        impl substreams_ethereum::Function for SetEdition {
            const NAME: &'static str = "setEdition";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SetMysteryBox {
            const METHOD_ID: [u8; 4] = [33u8, 131u8, 84u8, 225u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Tuple(
                            vec![
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .mystery_box.0.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .mystery_box.1.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .mystery_box.2.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
        ...
        impl substreams_ethereum::Function for SetMysteryBox {
            const NAME: &'static str = "setMysteryBox";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SetUri {
            const METHOD_ID: [u8; 4] = [2u8, 254u8, 83u8, 5u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetUri {
            const NAME: &'static str = "setURI";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for BundlePurchased {
            const NAME: &'static str = "BundlePurchased";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for BundleSet {
            const NAME: &'static str = "BundleSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct DetailsSet {
            pub conduit: Vec<u8>,
            pub revenue_recipient: Vec<u8>,
            pub randomness_provider: Vec<u8>,
            pub start_date: substreams::scalar::BigInt,
            pub end_date: substreams::scalar::BigInt,
            pub num_editions: substreams::scalar::BigInt,
            ...
            pub fn decode(
                ...
                Ok(Self {
                    conduit: ethabi::decode(
                        ...
                        .as_bytes()
                        .to_vec(),
                    revenue_recipient: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[2usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'revenue_recipient' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
                        ...
                        .as_bytes()
                        .to_vec(),
                    randomness_provider: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[3usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'randomness_provider' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
        ...
        impl substreams_ethereum::Event for DetailsSet {
            const NAME: &'static str = "DetailsSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for EditionPurchased {
            const NAME: &'static str = "EditionPurchased";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for EditionRedeemed {
            const NAME: &'static str = "EditionRedeemed";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for MysteryBoxPurchased {
            const NAME: &'static str = "MysteryBoxPurchased";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl MysteryBoxRevealRequested {
            const TOPIC_ID: [u8; 32] = [
                31u8,
                176u8,
                87u8,
        ...
        impl substreams_ethereum::Event for MysteryBoxRevealRequested {
            const NAME: &'static str = "MysteryBoxRevealRequested";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
                ...
                Ok(Self {
                    ...
                    randomness: {
                        ...
                        ethabi::decode(
                            ...
                            .map_err(|e| {
                                format!(
                                    "unable to decode param 'randomness' from topic of type 'uint256': {:?}",
                                    e
                                )
                            })?
                            .pop()
        ...
        impl substreams_ethereum::Event for MysteryBoxRevealed {
            const NAME: &'static str = "MysteryBoxRevealed";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct MysteryBoxSet {
            pub quantity: substreams::scalar::BigInt,
            pub price: substreams::scalar::BigInt,
            pub redemptions: substreams::scalar::BigInt,
        }
        impl MysteryBoxSet {
            const TOPIC_ID: [u8; 32] = [
                40u8,
        ...
        impl substreams_ethereum::Event for MysteryBoxSet {
            const NAME: &'static str = "MysteryBoxSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
